...
## BIG THING: THIS COULD ALSO BE USED TO SHOW WHICH VARIABLES ARE CONTRIBUTING TO THE LINE
...
# show age in years as X an blood pressure as y
plt.scatter(X[:,1], X[:,0])
plt.show()


# show weight in pounds as X an blood pressure as y
plt.scatter(X[:,2], X[:,0])
plt.show()
...
print "r2 for both only:",get_r2(X, Y)
